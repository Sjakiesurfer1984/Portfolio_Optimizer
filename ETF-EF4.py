...
class PortfolioOptimizer:
    ...
    def generate_random_weights(self, num_assets):
        while True:
            max_etf_weight = 0.4  # Maximum weight for a single ETF
            weights = np.random.choice(np.arange(0, 101, 1), size=num_assets) / 100  # Weights in steps of 1%
